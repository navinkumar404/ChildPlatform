          ...
          <div className="relative group shrink-0">
            <div className="flex h-28 w-28 items-center justify-center overflow-hidden rounded-2xl bg-amber-50">
              <Image 
                ...
                src="https://images.unsplash.com/photo-1554622965-bfaeff35e57f?q=80&w=1770&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" 
                width={112}
                height={112}
